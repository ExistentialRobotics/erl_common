...
namespace nlohmann {
    ...
    struct ConvertEigenMatrix {
        ...
        from_json(const json& array, Eigen::Matrix<T, Rows, Cols, Order>& mat) {
            ...
            if (!array[0].is_array()) { throw std::invalid_argument("The json array must be a 2D array."); }
    ...
    template<>
    struct adl_serializer<Eigen::Matrix2Xi> : ConvertEigenMatrix<int, 2, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix2Xf> : ConvertEigenMatrix<float, 2, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix2Xd> : ConvertEigenMatrix<double, 2, Eigen::Dynamic> {};
    ...
    template<>
    struct adl_serializer<Eigen::Matrix3Xi> : ConvertEigenMatrix<int, 3, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix3Xf> : ConvertEigenMatrix<float, 3, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix3Xd> : ConvertEigenMatrix<double, 3, Eigen::Dynamic> {};
    ...
    template<>
    struct adl_serializer<Eigen::Matrix4Xi> : ConvertEigenMatrix<int, 4, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix4Xf> : ConvertEigenMatrix<float, 4, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::Matrix4Xd> : ConvertEigenMatrix<double, 4, Eigen::Dynamic> {};
    ...
    template<>
    struct adl_serializer<Eigen::MatrixXi> : ConvertEigenMatrix<int, Eigen::Dynamic, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::MatrixXf> : ConvertEigenMatrix<float, Eigen::Dynamic, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::MatrixXd> : ConvertEigenMatrix<double, Eigen::Dynamic, Eigen::Dynamic> {};
    ...
    template<>
    struct adl_serializer<Eigen::VectorXi> : ConvertEigenVector<int, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::VectorXf> : ConvertEigenVector<float, Eigen::Dynamic> {};

    template<>
    struct adl_serializer<Eigen::VectorXd> : ConvertEigenVector<double, Eigen::Dynamic> {};
}  // namespace nlohmann
